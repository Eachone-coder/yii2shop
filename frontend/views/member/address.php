                ...
                <form action="" name="address_form" id="address_form">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <input type="checkbox" name="is_default" class="check" id="is_default" value="1" />设为默认地址
                        </li>
                        <li>
                            <label for="">&nbsp;</label>
...
<script type="text/javascript">
            ...
            if (!id){
                ...
                $.post('<?=\yii\helpers\Url::to(['member/edit-address'])?>',{'id':id,'form':form},function (data) {
                    if (data.data){
                        ...
                        html+='</dd>';
                        html+='</dl>';
                        $('.content').find('dl:last').toggleClass('last');
                        $('#'+id).html(html);
                    }
                },'json');
            }
        ...
        $('.ml10').on('click','.btn-info',function () {
            if(confirm('确定设置该默认地址?')){
                var id=$(this).closest('dl').attr('id');
                $.getJSON('<?php echo \yii\helpers\Url::to(['member/edit-default'])?>',{"id":id},function (data) {
                    if(data.status){
