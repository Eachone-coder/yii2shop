...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="<?=\yii\helpers\Url::to(['site/index'])?>"><img src="/images/logo.png" alt="岛上书店" ></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
        ...
        <div class="user fl">
            <dl>
                ...
                <dd>
                    <div class="prompt">
                        <?=(Yii::$app->user->identity)?Yii::$app->user->identity->username:'您好，请<a href="">登录</a>'?>
                    </div>
